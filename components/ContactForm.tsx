...
const ContactForm = () => {
  return (
    <div className="bg-neutral-100 dark:bg-slate-700 shadow-lg max-w-lg p-6 rounded-md">
      <form id="contactForm" className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-blue-500 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-600 transition-all duration-300 transform hover:scale-[1.02]"
        >
          Send Message
          <svg
